...
def test_get_company_prices_invalid_period_returns_400(db_session):
    ...
    # "5y" became a valid period with the Company Dossier (worktree-ui-v4,
    # PRICE_SERIES_PERIODS in routers/companies.py) -- "10y" stays invalid.
    resp = client.get(f"/api/companies/{company.id}/prices?period=10y")
